...
if st.button("Generate Meal Plan"):
    with st.expander("Enter Meal Plan Details"):
...
if st.button("Suggest Ingredient Substitutions"):
    with st.expander("Enter Ingredients"):
...
if st.button("Personalize Recipe"):
    with st.expander("Enter Recipe Preferences"):
        ...
        if st.button("Submit Recipe Preferences"):
            prompt = f"""
